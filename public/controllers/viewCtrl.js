...
//    }
        ...
        userService.getAll()
            .then(function(result) {
                ...
                for(var i = 0; i < result.data.length; i++) {
                    ...
                    if (result.data[i].coverPic == undefined){
                        result.data[i].coverPic = 'Images/default-cover.jpg';
                    }
                }
    ...
    $scope.selectedSite = profile.data.website;
    if (profile.data.coverPic == undefined) {
        $scope.selectedCover = "Images/default-cover.jpg"
    } else {
